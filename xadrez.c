...
int main(){
    // Corrige a saída de dados para o padrão UTF-8 para exibir caracteres corretamente no console.
    SetConsoleOutputCP(CP_UTF8);
    int opcao; // Variável para armazenar a opção de peça escolhida pelo usuário
    char tabuleiro[CASAS_TABULEIRO][CASAS_TABULEIRO]; // Matriz 2D para representar o tabuleiro
    ...
    // Estrutura de controle switch para lidar com a opção escolhida pelo usuário.
    switch(opcao){
        case 1: // Caso a opção seja 1 (Torre)
        ...
        case 2: // Caso a opção seja 2 (Bispo)
        ...
        case 3: // Caso a opção seja 3 (Rainha)
        ...
        case 4: // Caso a opção seja 4 (Cavalo)
